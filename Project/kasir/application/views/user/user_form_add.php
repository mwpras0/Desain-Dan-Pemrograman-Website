		...
		<div class="col-12 d-flex no-block align-items-center">
			...
			<div class="ml-auto text-right">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						<li class="breadcrumb-item active" aria-current="page"> <b>Pengguna > Tambah</b></li>
					</ol>
				</nav>
			</div>
		</div>
...
<div class="container-fluid">
	...
	<div class="card">
		<div class="card-body">
			<h3 class="card-title float-left">Tambah Pengguna</h3>
			...
			<div class="col-md-8 ml-3">
				...
				<form action="" method="post">
					<div class="form-group row">
						...
						<div class="col-sm-7">
                            <input type="text" name="fullname" value="<?=set_value('fullname') ?>" class="form-control" id="fname">
					...
					<div class="form-group row">
						...
						<div class="col-sm-7">
							<textarea type="text" name="address" class="form-control" id="address"><?=set_value('address') ?></textarea>
						</div>
                    </div>
                    <div class="form-group row">
