		...
		<h2 class="page-title">Unit
			...
			<div class="ml-auto text-right">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						<li class="breadcrumb-item active" aria-current="page"> <b>Produk > Unit > Edit</b></li>
					</ol>
				</nav>
			</div>
		</div>
...
<div class="container-fluid">
	...
	<div class="card">
		<div class="card-body">
			<h3 class="card-title float-left">Edit Unit</h3>
			<div class="float-right">
				<a href="<?=site_url('unit')?>" class="btn btn-warning"><i class="mdi mdi-undo"></i>Back</a>
			</div>
		</div>
		<div class="row">
				...
				<form action="" method="post">
					<div class="form-group row">
						...
						<div class="col-sm-7">
                            ...
                            <input type="text" name="name" value="<?=$this->input->post('name') ?? $row->name ?>" class="form-control" id="name">
