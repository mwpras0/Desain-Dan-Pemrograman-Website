...
<body>
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center bg-dark">
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    ...
                    <!-- Form -->
                    <form class="form-horizontal m-t-20" id="loginform" action="<?=site_url('auth/process')?>" method="post">
    ...
    <script src="<?php echo base_url() ?>assets/assets/libs/sweetalert/sweetalert2.js"></script>
    <!-- ============================================================== -->
    <!-- This page plugin js -->
    <!-- ============================================================== -->
    <script>
